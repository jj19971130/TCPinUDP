...
public class Kcp
{
    ...
    private int incr;
    private final LinkedList<Segment> snd_queue = new LinkedList<Segment>();
    private final LinkedList<Segment> rcv_queue = new LinkedList<Segment>();
    private final LinkedList<Segment> snd_buf = new LinkedList<Segment>();
    private final LinkedList<Segment> rcv_buf = new LinkedList<Segment>();
    private final LinkedList<Integer> acklist = new LinkedList<Integer>();
